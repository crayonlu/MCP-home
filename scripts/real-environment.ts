...
const child = spawn(process.execPath, childArguments, {
  ...
  env: {
    ...process.env,
    MCP_HOME_HOST: '127.0.0.1',
    MCP_HOME_PORT: String(port),
    MCP_HOME_PUBLIC_URL: baseUrl.toString(),
    MCP_HOME_DATA_DIR: dataDirectory,
    MCP_HOME_MASTER_KEY: masterKey,
    MCP_HOME_BOOTSTRAP_CONTROL_KEY: controlKey,
    MCP_HOME_ALLOWED_HOSTS: '127.0.0.1',
    MCP_HOME_LOG_LEVEL: 'error',
  },
